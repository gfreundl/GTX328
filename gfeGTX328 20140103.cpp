...
011		male and female alert voices, - Bezel on/off
...
AlertSounds			0 = bell, 1 = male voice, 2 = female voice
...
- one time audio alerts "Timer expired"  "Leaving Altitude"
...
- FL trend threshold arounf 50fpm for small, 500fpm for long arrow (config)
- Altitude Monitor should show deviation in tens, not hundreds
- ALT MON alert threshold 250ft (config)
